...
namespace Day2_CorruptionChecksum
{
    class Program
    {
        ...
        private static void FirstPart(int[] mas)
        {
            int result = 0;
            for (int i = 0; i < mas.Length; i += 16)
            {
                int max, min;
                max = min = mas[i];
                for (int j = 1; j < 16; j++)
        ...
        private static void SecondPart(int[] mas)
        {
            int result = 0;
            for (int i = 0; i < mas.Length; i += 16)
            {
